...
If you have installed the unmodified version of this card via HACS in the past or added it manually you will need to remove it otherwise it will conflict with the modified version from this repo.
